...
'INSTANT VB NOTE: The variable resources was renamed since it may cause conflicts with calls to static members of the user-defined type with this name:
			...
			' 
			' 
			Me.compositeLink1.ImageCollection.ImageStream = (CType(resources_Conflict.GetObject("compositeLink1.ImageCollection.ImageStream"), DevExpress.Utils.ImageCollectionStreamer))
